/*
 * I2C.c includes the driver files to initialize the I2c communication between the accelerometer
 * and the SoC
 *
 ...
 *
 * The I2c Driver code was taken from Alexander Dean's Github.
 *
